      ...
      <div className="layout">
        ...
        <Collapse.Group>
            ...
            <Collapse title="Вектор" initialVisible>
              <Text>Спрашивайте документы об их содержимом: задавайте вопросы на привычном языке и получайте интеллектуальные и обоснованные ответы, включая результаты выполнения различных необходимых транформаций данных и использования семантического поиска.</Text>
            </Collapse>
        ...
        <p className="contact">
          <Link href="mailto:portal@ic-ie.com?subject=ОС Портал&body=Заявка на экземпляр ОС Портал" color>
