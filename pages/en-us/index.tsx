        ...
        <Grid.Container gap={2} justify="center">
          <Grid xs={24} md={8}>
            <HomeCell
              ...
              desc="Облачная операционная система с возможностью управления естественным языком с любого устройства, включая очки, часы и домашний сервер"
              />
          </Grid>
          <Grid xs={24} md={8}>
            <HomeCell
              ...
              desc="Защищенное облачное хранилище, с семантическим поиском, пониманием смысла документов, и объектов и событий на фото и видео"
