  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Портал — Облачная диалоговая операционная система и персональные автономные цифровые ассистенты на основе технологий искуственного интеллекта и маркетплейс ИИ-приложений."
        />
        <meta
          property="og:description"
          content="Облачная диалоговая операционная система и персональные автономные цифровые ассистенты на основе технологий искуственного интеллекта и маркетплейс ИИ-приложений."
        />
        <meta
          itemProp="image"
          property="og:image"
